...
export default async function Home({searchParams:{page = "1"}}: HomeProps) {
  ...
  return (
    <main className="bg-gradient-to-r from-purple-200 from-5% via-pink-200 via-30% to-emerald-100 to-95% ...">
      <div className="flex min-h-screen items-stretch justify-between bg-slate-300/[.45] p-5 mx-20 rounded-lg space-x-10">
            ...
            <form action={sortPosts}>
              <div className="flex space-x-16">
                ...
                <div className="flex items-center space-x-1">
                  <SelectCategoty
                    className="dropdown z-[1] menu p-2 shadow bg-slate-200/[.20] w-52 rounded"
                  />
                  <SearchButton
